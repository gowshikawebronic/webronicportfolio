...
export default function CareerSection() {
  return (
    <section
      id="career"
      className="relative py-20  bg-white font-sora overflow-hidden px-5 lg:px-25"
    >
      <div className="absolute top-0 right-0 w-125 h-125 bg-[#2776ea]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-16 lg:mb-24">
          ...
          <Link
            href="/career"
            className="group inline-flex items-center gap-3 bg-[#2776ea] text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#76ea27] transition-all shadow-2xl hover:shadow-blue-500/20 active:scale-95"
          >
            View All Openings
            <ArrowRight
              size={20}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {perks.map((perk, i) => (
            ...
            >
              <div className="h-14 w-14 bg-white rounded-2xl flex items-center justify-center text-[#76ea27] shadow-sm mb-6 group-hover:bg-[#76ea27] group-hover:text-white transition-all duration-500">
