...
export default function Hero() {
  ...
  return (
    <section
      id="/"
      className="relative overflow-hidden bg-white py-20 mt-10 font-sora"
    >
      <style>{`
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="flex flex-col text-center lg:text-left">
            <div className="mb-8 inline-flex self-center lg:self-start items-center gap-2 rounded-full bg-slate-50 border border-slate-200 px-4 py-1.5 text-[10px] font-black uppercase tracking-widest text-[#4a7dc0]">
              <Sparkles size={14} className="text-[#63b344]" />
              Innovation by WEBRONIC
            </div>

            <h1 className="min-h-45 text-5xl font-black tracking-tight text-slate-900 sm:text-6xl lg:text-7xl leading-[1.1]">
              The Future of Retail, <br />
              <span className="text-[#4a7dc0]">
                {displayText}
            ...
            <div className="relative w-full max-w-125 aspect-square flex items-center justify-center">
              ...
              >
                ...
                <div className="absolute top-8 right-8 rounded-full bg-white/90 backdrop-blur-md px-4 py-2 shadow-sm border border-slate-100 flex items-center gap-3">
                  <div className="h-2 w-2 rounded-full bg-[#63b344] animate-pulse" />
              ...
              <div className="absolute -bottom-10 -right-10 h-64 w-64 bg-[#4a7dc0]/10 blur-[100px] rounded-full z-[-1]" />
            </div>
          </div>
        </div>
      </div>
