        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            <h3 className="flex items-center gap-3 text-xl font-black text-slate-900 mb-8">
              <span className="h-8 w-1 bg-[#4a7dc0] rounded-full" />
              India Operations
            </h3>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={idx} className="group flex items-start gap-4 p-6 rounded-3xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-xl hover:shadow-blue-900/5 transition-all duration-300">
                  <div className="shrink-0 h-10 w-10 rounded-xl bg-white border border-slate-100 flex items-center justify-center text-[#4a7dc0] shadow-sm group-hover:bg-[#4a7dc0] group-hover:text-white transition-colors">
                    <MapPin size={18} />
                  </div>
                  <div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              <h3 className="flex items-center gap-3 text-xl font-black text-slate-900 mb-8">
                <span className="h-8 w-1 bg-[#63b344] rounded-full" />
                European Operations
              </h3>
              <div className="p-8 rounded-[2.5rem] bg-slate-900 text-white relative overflow-hidden">
                <div className="relative z-10">
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#63b344] mb-3">Strategic Partner</p>
            ...
            {/* Global Reach */}
            <div className="flex-1 bg-gradient-to-br from-[#4a7dc0]/5 to-transparent rounded-[2.5rem] p-8 border border-[#4a7dc0]/10">
               <h3 className="flex items-center gap-2 text-sm font-black text-slate-900 uppercase tracking-widest mb-4">
                 <Globe2 size={16} className="text-[#4a7dc0]" /> Global Reach
               </h3>
