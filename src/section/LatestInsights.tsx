...
const INSIGHTS = [
  {
    ...
    color: "from-[#4a7dc0] to-[#3a6db0]", // Blue Gradient for fallback/overlay
    link: "#"
  },
  {
    id: 2,
    ...
    color: "from-[#63b344] to-[#4a9f30]", // Green Gradient for fallback/overlay
    link: "#"
  },
  {
    id: 3,
  ...
  return (
    <section className=" py-20 md:py-28 font-sora relative overflow-hidden px-5 lg:px-25">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-40">
        <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#4a7dc0]/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] bg-[#63b344]/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-1">
                <div className="flex items-center gap-3 text-xs font-bold text-slate-400 mb-4">
                  <Calendar size={14} className="text-[#4a7dc0]" />
                  <span>{post.date}</span>
                </div>

                <h3 className="text-xl font-black text-slate-900 mb-4 leading-snug group-hover:text-[#4a7dc0] transition-colors">
                  {post.title}
                </h3>
                ...
                <div className="pt-6 border-t border-slate-50 flex items-center justify-between">
                  ...
                  <div className="h-10 w-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-[#4a7dc0] group-hover:text-white transition-all duration-300">
        ...
        <div className="mt-16 text-center">
          <Link 
            href="/insights" 
            className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-[#4a7dc0] text-white text-xs font-black uppercase tracking-widest hover:bg-[#63b344] transition-all shadow-lg hover:shadow-blue-500/25 active:scale-95"
          >
