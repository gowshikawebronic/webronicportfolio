    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-20 right-[10%] w-64 h-96 opacity-10 hidden lg:block">
            <div className="font-mono text-xs text-[#4a7dc0] space-y-2">
        ...
        <div className="absolute top-1/3 right-0 w-[500px] h-[500px] opacity-20">
            ...
            <div className="absolute top-10 right-20 animate-float-slow">
                <Brain size={64} className="text-[#4a7dc0]" />
                <div className="absolute top-1/2 left-1/2 w-32 h-0.5 bg-gradient-to-r from-[#4a7dc0] to-transparent -translate-x-full" />
            </div>
            {/* Node 2: Server (Cloud) */}
            <div className="absolute top-40 right-60 animate-float-medium">
                <Server size={48} className="text-[#63b344]" />
                <div className="absolute top-full left-1/2 h-24 w-0.5 bg-gradient-to-b from-[#63b344] to-transparent" />
            </div>
            ...
            {/* Connection Lines */}
            <svg className="absolute inset-0 w-full h-full stroke-[#4a7dc0] stroke-1 fill-none opacity-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center w-full">
          ...
          <div className="flex flex-col text-center lg:text-left z-20">
            ...
            <div className="mb-4 flex flex-wrap justify-center lg:justify-start items-center gap-3 text-xs font-bold tracking-widest uppercase text-slate-400">
              <span className="text-[#4a7dc0]">Global IT Services</span>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter text-slate-900 leading-[1.1]">
              ...
              <span className="text-3xl sm:text-4xl lg:text-5xl text-slate-400 font-extrabold block mt-1">
                Through 
                <span className="bg-gradient-to-r from-[#4a7dc0] to-[#63b344] bg-clip-text text-transparent ml-2">
            ...
            <div className="flex flex-wrap justify-center items-center lg:justify-start gap-4 mt-8 mb-8">
                <Link 
                  href="/service" 
                  className="px-5 py-3 rounded-xl bg-[#4a7dc0] text-white text-sm font-bold  tracking-widest hover:bg-[#63b344] transition-all shadow-lg shadow-blue-900/20 active:scale-95"
                >
                  Explore Our Solutions
                </Link>
                <Link 
                  href="/contact" 
                  className="px-4 py-2 rounded-xl border-2 border-slate-200 text-slate-600 text-sm font-bold  tracking-widest hover:border-[#4a7dc0] hover:text-[#4a7dc0] transition-all active:scale-95 bg-white/50 backdrop-blur-sm"
                >
                  Talk to an Expert
                </Link>
            </div>
            ...
            <div key={activeIndex} className="mt-4 animate-text-reveal min-h-[220px]">
                <div className="flex items-center justify-center lg:justify-start gap-2 mb-2">
                    <span className="h-px w-6 bg-[#63b344]"></span>
                    <span className="text-xs font-bold text-[#63b344] uppercase tracking-widest">{activeSlide.title}</span>
                </div>
                ...
                <div className="mt-4 flex flex-wrap justify-center lg:justify-start gap-2">
                    {activeSlide.stats.map((stat, i) => (
                         <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100 text-xs font-bold text-slate-600">
                            <CheckCircle2 size={12} className="text-[#63b344]" />
                            {stat}
                         </span>
                    ))}
                </div>
                ...
                <div className="mt-5 flex justify-center lg:justify-start">
                    <a 
                      ...
                      className="group inline-flex items-center gap-2 text-sm font-bold text-[#4a7dc0] hover:text-[#3a6db0] transition-all"
                    >
                        {activeSlide.cta} 
              ...
              {CAROUSEL_DATA.map((_, idx) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    idx === activeIndex ? "w-6 bg-[#4a7dc0]" : "w-1.5 bg-slate-200 hover:bg-slate-300"
                  }`}
                ...
                {TRUST_INDICATORS.map((item, idx) => (
                    <div key={idx} className="flex flex-col items-center lg:items-start">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1">
                            <item.icon size={10} className="text-[#63b344]" /> {item.label}
                        </span>
                    </div>
                ))}
            </div>
          ...
          <div className="relative hidden lg:flex justify-end items-center h-[450px] perspective-1000">
            ...
            <div className="relative w-[320px] h-[420px]">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[400px] bg-[#4a7dc0]/10 blur-[60px] rounded-full z-[-1]" />
              ...
              >
                <div className="relative h-full w-full group cursor-grab active:cursor-grabbing p-10 flex flex-col justify-center items-center">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-center">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-[#63b344] mb-1 bg-white/90 inline-block px-2 py-1 rounded-full shadow-sm">{activeSlide.title}</p>
                  </div>
                </div>
              </div>
