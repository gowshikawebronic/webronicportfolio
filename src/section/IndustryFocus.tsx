  ...
  return (
    <section className=" py-20 md:py-28 font-sora relative overflow-hidden px-5 lg:px-25">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-30">
        <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#4a7dc0]/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#63b344]/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {INDUSTRIES.map((industry, index) => (
            <div
              key={industry.id}
              className="group relative bg-white rounded-[2.5rem] p-8 border border-slate-100 hover:border-[#4a7dc0]/30 hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 flex flex-col h-full"
            >
              {/* Icon Header */}
              <div className="flex items-start justify-between mb-6">
                ...
                <ArrowUpRight
                  size={20}
                  className="text-slate-300 group-hover:text-[#4a7dc0] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300"
                />
              </div>

              {/* Text Content */}
              <h3 className="text-xl font-black text-slate-900 mb-3 group-hover:text-[#4a7dc0] transition-colors">
                {industry.title}
              </h3>
              ...
              {/* Hover Decor */}
              <div className="absolute inset-0 rounded-[2.5rem] border-2 border-transparent group-hover:border-[#4a7dc0]/10 pointer-events-none transition-colors duration-500" />
            </div>
          ))}
        </div>
      </div>
