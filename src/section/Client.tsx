...
const INDUSTRIES = [
  { name: "Manufacturing & Industrial", percent: 35, icon: Factory, color: "bg-[#4a7dc0]" },
  { name: "Retail & E-commerce", percent: 25, icon: ShoppingBag, color: "bg-[#63b344]" },
  { name: "Financial Services", percent: 20, icon: Landmark, color: "bg-[#4a7dc0]" },
  { name: "Healthcare", percent: 10, icon: HeartPulse, color: "bg-[#63b344]" },
  ...
  return (
    <section id="client" className="relative overflow-hidden bg-white py-16 md:py-24 font-sora px-5 lg:px-10">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40">
         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#4a7dc0]/5 rounded-full blur-[120px]" />
         <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#63b344]/5 rounded-full blur-[120px]" />
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-20 mt-20 border-t border-slate-100 pt-20">
          ...
          <div>
            <h3 className="text-2xl font-black text-slate-900 mb-8 flex items-center gap-3">
              <span className="w-8 h-1 bg-[#4a7dc0] rounded-full" /> Industry Distribution
            </h3>
                ...
                <div key={i} className="group">
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center gap-3">
                      <ind.icon size={16} className="text-slate-400 group-hover:text-[#4a7dc0] transition-colors" />
          ...
          <div>
            <h3 className="text-2xl font-black text-slate-900 mb-8 flex items-center gap-3">
              <span className="w-8 h-1 bg-[#63b344] rounded-full" /> Featured Stories
            </h3>
              ...
              {TESTIMONIALS.map((t, i) => (
                <div 
                  ...
                  className={`rounded-[2rem] border transition-all duration-500 overflow-hidden ${
                    activeTestimonial === i 
                      ? "bg-white border-[#4a7dc0]/20 shadow-xl shadow-blue-900/5" 
