...
const EnquiryModal = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#336fa5] p-6 md:p-8 text-white">
          ...
          <p className="mt-2 text-blue-50 text-xs md:text-sm opacity-90 font-medium">
            Consulting for{" "}
            <span className="font-bold underline decoration-[#5ba12d]">
              {service.title}
            </span>
          </p>
        </div>
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full rounded-xl border border-slate-200 pl-10 md:pl-12 p-3 md:p-3.5 text-sm md:text-base focus:border-[#336fa5] focus:ring-4 focus:ring-blue-50 outline-none transition font-medium appearance-none bg-white text-slate-700 cursor-pointer"
                required
              >
                {services.map((s) => (
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-slate-200 pl-10 md:pl-12 p-3 md:p-3.5 text-sm md:text-base focus:border-[#336fa5] focus:ring-4 focus:ring-blue-50 outline-none transition resize-none font-medium text-slate-700"
                required
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="group mt-2 flex w-full items-center justify-center gap-3 rounded-xl md:rounded-2xl bg-[#336fa5] py-3.5 md:py-4 text-xs md:text-sm font-extrabold uppercase tracking-widest text-white shadow-xl shadow-blue-200 hover:bg-[#3a71c5] transition-all hover:translate-y-[-2px] active:scale-95"
          >
            Send Inquiry
            <Send
              size={16}
...
const ServiceCard = ({
  ...
  return (
    <div
      ...
      className="animate-on-load group relative overflow-hidden rounded-[1.5rem] md:rounded-[2.5rem] border border-slate-100 bg-white p-6 md:p-12 shadow-xl shadow-slate-200/50 transition-all duration-700 hover:shadow-2xl hover:shadow-[#336fa5]/10 hover:-translate-y-2 opacity-0 font-sora"
    >
      ...
      <div className="grid gap-8 md:gap-12 lg:grid-cols-[1.3fr_0.7fr] items-center">
        <div className="flex flex-col h-full relative z-10">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-6 text-center sm:text-left">
            <div className="flex h-14 w-14 md:h-16 md:w-16 shrink-0 items-center justify-center rounded-xl md:rounded-2xl bg-[#336fa5] text-white shadow-lg shadow-blue-100 transition-all duration-500 group-hover:rotate-12 group-hover:scale-110">
              {service.icon}
            </div>
            <div>
              <div className="flex items-center justify-center sm:justify-start gap-2 mb-1.5 md:mb-2">
                <span className="h-1.5 w-1.5 rounded-full bg-[#5ba12d]" />
                <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-[#5ba12d]">
                  {service.tagline}
                </p>
              </div>
          ...
          <div className="mt-6 md:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-y-3 md:gap-y-4 gap-x-8">
            {service.points.map((point, idx) => (
              <div key={idx} className="flex items-center gap-3 group/point">
                <div className="flex h-5 w-5 md:h-6 md:w-6 items-center justify-center rounded-full bg-blue-50 text-[#336fa5] transition-colors group-hover/point:bg-[#5ba12d] group-hover/point:text-white shrink-0">
          ...
          <div className="mt-auto pt-8 md:pt-12">
            <button
              onClick={onToggle}
              className="flex items-center justify-center cursor-pointer sm:justify-start w-full sm:w-auto gap-2 text-[13px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-[#336fa5] transition-colors"
            >
              The Stack
              <ChevronDown
                className={`h-5 w-5 transition-transform duration-500  ${
                  isOpen ? "rotate-180 text-[#336fa5]" : ""
                }`}
              />
            </button>
            ...
            <div className="mt-6 md:mt-10">
              <button
                ...
                className="group/btn relative w-full cursor-pointer sm:w-auto inline-flex items-center justify-center gap-3 overflow-hidden rounded-xl md:rounded-2xl bg-[#336fa5] px-8 md:px-10 py-3.5 md:py-4 text-[10px] md:text-xs font-black uppercase tracking-[0.1em] text-white shadow-2xl shadow-blue-200 transition-all hover:bg-[#5ba12d]"
              >
        ...
        <div className="relative flex items-center justify-center lg:justify-end order-first lg:order-last">
          ...
          <div className="relative p-2 md:p-4">
            <div className="absolute -inset-1 md:-inset-2 rounded-[1.5rem] md:rounded-[2rem] border border-dashed border-[#5ba12d]/20 " />
            <img
              src={service.image}
              alt={service.title}
