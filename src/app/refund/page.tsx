    ...
    <main className="bg-white font-sora w-full overflow-x-hidden pt-12 md:pt-24 pb-20">
      <section className="relative overflow-hidden bg-slate-50 py-16 md:py-24 border-b border-slate-100">
        <div className="absolute inset-0 pointer-events-none opacity-40">
          <div className="absolute -top-10 -right-10 w-64 h-64 md:w-125 md:h-125 bg-[#4a7dc0]/10 rounded-full blur-[80px] md:blur-[120px]" />
          <div className="absolute -bottom-10 -left-10 w-64 h-64 md:w-125 md:h-125 bg-[#63b344]/10 rounded-full blur-[80px] md:blur-[120px]" />
        </div>

        <div className="relative mx-auto max-w-7xl px-4 md:px-6">
          <div className="flex items-center  gap-4 mb-6">
            <CreditCard size={14} className="text-[#4a7dc0]" />
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4 md:gap-8 text-xs md:text-sm font-bold text-slate-400">
            <div className="flex items-center gap-2">
              <Clock size={18} className="text-[#4a7dc0]" /> Dec 18, 2025
            </div>
            <div className="flex items-center gap-2">
              <Scale size={18} className="text-[#63b344]" /> Webronic Industries
              Pvt Ltd
            </div>
          </div>
        </div>
      ...
      <div className="lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-100 flex items-center overflow-x-auto no-scrollbar px-4 py-3 gap-2">
        {sections.map((item) => (
          <button
            ...
            className="whitespace-nowrap flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-[10px] font-black uppercase text-slate-500 active:bg-[#4a7dc0] active:text-white transition-all"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="space-y-1">
              {sections.map((item) => (
                ...
                >
                  <item.icon
                    size={16}
                    className="group-hover:text-[#4a7dc0] transition-colors"
                  />
                  {item.title}
                </button>
              ))}
          ...
          <div className="flex-1 space-y-20 md:space-y-32">
            <div id="overview" className="scroll-mt-24 md:scroll-mt-32">
              <div className="bg-[#4a7dc0]/5 rounded-2xl md:rounded-3xl p-6 md:p-10 border border-[#4a7dc0]/10">
                <h2 className="text-xl md:text-2xl font-black text-slate-900 mb-4 flex items-center gap-2">
                  <ShieldCheck className="text-[#4a7dc0] shrink-0" /> 1. Policy
                  Overview
                </h2>
              ...
              <div className="space-y-6 md:space-y-8">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      >
                        <CheckCircle2
                          size={16}
                          className="text-[#63b344] mt-0.5 shrink-0"
                        />{" "}
                        {item}
                      </li>
                    ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-6 rounded-2xl border border-slate-100">
                    <p className="text-[10px] font-black text-[#4a7dc0] uppercase mb-2">
                      3.2 Recurring
                    </p>
            ...
            <div id="refund-policy" className="scroll-mt-24 md:scroll-mt-32">
              ...
              <div className="bg-slate-900 text-white rounded-4xl md:rounded-[2.5rem] p-6 md:p-10 relative overflow-hidden">
                <p className="text-xs font-black text-[#63b344] uppercase tracking-[0.2em] mb-6">
                  Calculation Logic
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[10px] md:text-[11px] font-black uppercase tracking-widest opacity-70">
                  <div className="flex gap-2">
                    <ArrowRight size={14} className="text-[#63b344] shrink-0" />{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="p-6 md:p-8 rounded-2xl md:rounded-4xl border border-slate-100 bg-white">
                  ...
                  <p className="text-sm text-slate-600 font-medium leading-relaxed">
                    Contact{" "}
                    <span className="text-[#4a7dc0] font-bold break-all">
                ...
                <div className="p-6 md:p-8 rounded-2xl md:rounded-4xl bg-slate-900 text-white">
                  <h4 className="text-[10px] font-black text-[#63b344] uppercase tracking-widest mb-4">
                    6.2 Escalation
                  </h4>
                  <p className="text-sm opacity-80 font-medium leading-relaxed">
                    Email{" "}
                    <span className="text-[#63b344] font-bold break-all">
            ...
            <div id="special" className="scroll-mt-24 md:scroll-mt-32">
              ...
              <div className="space-y-4">
                <div className="p-6 md:p-8 rounded-2xl md:rounded-4xl bg-slate-50 border border-slate-100 flex flex-col sm:flex-row items-start gap-4 md:gap-6">
                  <AlertCircle className="text-[#4a7dc0] shrink-0" size={32} />
                  <div>
            ...
            <div id="scope" className="scroll-mt-24 md:scroll-mt-32">
              ...
              <div className="bg-slate-900 text-white p-6 md:p-10 rounded-2xl md:rounded-[2.5rem]">
                ...
                <div className="flex items-center gap-3 text-[10px] font-black text-[#63b344] uppercase tracking-widest">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
              ...
              >
                <h4 className="text-xs font-black text-[#4a7dc0] uppercase mb-4 flex items-center gap-2">
              ...
              >
                <h4 className="text-xs font-black text-[#63b344] uppercase mb-4 flex items-center gap-2">
            ...
            <div className="mt-10 md:mt-20 pt-10 md:pt-16 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
              <div className="text-center md:text-left">
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-center justify-center md:justify-start gap-3 md:gap-4 text-sm font-bold text-[#4a7dc0] break-all">
              ...
              <div className="bg-[#4a7dc0]/5 p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] border border-[#4a7dc0]/10 flex flex-col justify-between">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 bg-[#4a7dc0] text-white px-4 md:px-8 py-4 rounded-xl md:rounded-2xl font-black text-[10px] md:text-[11px] uppercase tracking-widest hover:bg-[#63b344] transition-all shadow-xl active:scale-95"
                >
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 text-sm outline-none focus:border-[#4a7dc0]"
                      required
                    />
                    <input
                      type="text"
                  ...
                  <textarea
                    placeholder="Reason"
                    rows={3}
                    className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 text-sm outline-none focus:border-[#4a7dc0] resize-none"
                    required
                  />
                  <button className="w-full bg-[#4a7dc0] text-white py-4 md:py-5 rounded-xl font-black text-[10px] md:text-[11px] uppercase tracking-[0.2em] shadow-lg hover:bg-[#63b344] transition-all active:scale-95">
                    Submit Request
                  </button>
                </form>
              </>
