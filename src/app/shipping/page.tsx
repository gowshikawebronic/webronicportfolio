    ...
    <main className="bg-white font-sora w-full overflow-x-hidden pt-4">
      ...
      <section className="relative overflow-hidden bg-slate-50 py-12 md:py-24 border-b border-slate-100">
        <div className="absolute inset-0 pointer-events-none opacity-40">
           <div className="absolute -top-10 -right-10 w-40 h-40 md:w-[500px] md:h-[500px] bg-[#336fa5]/10 rounded-full blur-[60px] md:blur-[120px]" />
           <div className="absolute -bottom-10 -left-10 w-40 h-40 md:w-[500px] md:h-[500px] bg-[#5ba12d]/10 rounded-full blur-[60px] md:blur-[120px]" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 md:px-6">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-black text-slate-900 tracking-tighter leading-[1.1]">
            Shipping & <span className="bg-gradient-to-r from-[#336fa5] to-[#5ba12d] bg-clip-text text-transparent">Exchange</span>
          </h1>
          <div className="mt-8 flex flex-wrap items-center gap-6 md:gap-8 text-xs md:text-sm font-bold text-slate-400">
            <div className="flex items-center gap-2">
              <Clock size={18} className="text-[#336fa5]" /> <span>Updated: Dec 18, 2025</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-100 flex items-center overflow-x-auto no-scrollbar px-4 py-4 gap-3">
        {sections.map((item) => (
          <button
            ...
            className="whitespace-nowrap flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-[10px] font-black uppercase text-slate-500 active:bg-[#336fa5] active:text-white transition-colors"
          >
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-10 md:py-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          {/* --- DESKTOP SIDEBAR --- */}
          <aside className="hidden lg:block w-[300px] flex-shrink-0 sticky top-32 h-[calc(100vh-140px)] overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-1">
              {sections.map((item) => (
                <button
                  key={item.id}
                  onClick={() => scrollToSection(item.id)}
                  className="w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-widest text-slate-500 hover:bg-slate-50 hover:text-[#336fa5] transition-all group text-left border border-transparent"
                >
                  <item.icon size={16} className="group-hover:text-[#336fa5]" />
                  {item.title}
                </button>
              ))}
            </div>
          ...
          <div className="flex-1 space-y-20 md:space-y-32">
            ...
            <div id="overview" className="scroll-mt-24">
              <div className="bg-[#336fa5]/5 rounded-[2rem] p-7 md:p-10 border border-[#336fa5]/10">
                ...
                <table className="w-full text-left border-collapse min-w-[600px]">
                  ...
                  <tbody className="divide-y divide-slate-100 font-medium">
                    <tr className="text-sm">
                      <td className="px-6 py-4 text-slate-900">Contracts & Legal</td>
                      <td className="px-6 py-4 text-slate-500">Courier / Speed Post</td>
                      <td className="px-6 py-4 text-[#336fa5]">3-5 Business Days</td>
                    </tr>
                    <tr className="text-sm">
                      <td className="px-6 py-4 text-slate-900">Hardware / Equipment</td>
                      <td className="px-6 py-4 text-slate-500">Courier with Tracking</td>
                      <td className="px-6 py-4 text-[#336fa5]">5-7 Business Days</td>
                    </tr>
                    <tr className="text-sm">
                      <td className="px-6 py-4 text-slate-900">Training Materials</td>
                      <td className="px-6 py-4 text-slate-500">Standard Post</td>
                      <td className="px-6 py-4 text-[#336fa5]">5-7 Business Days</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div id="damage" className="scroll-mt-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-8 rounded-[2rem] border border-slate-100">
                   ...
                   <p className="text-xs text-slate-500 mb-4 leading-relaxed">Document damage with photos and contact us within 24 hours.</p>
                   <p className="text-xs font-bold text-[#336fa5] break-all">support@webronic.com</p>
                </div>
                <div className="p-8 rounded-[2rem] bg-slate-900 text-white">
                   ...
                   <p className="text-xs opacity-70 mb-4 leading-relaxed">Investigation takes 7-14 days. We arrange replacements at no cost once verified.</p>
                </div>
              </div>
            </div>
                   ...
                   <ul className="space-y-3">
                      {["Defective Hardware", "Wrong Items Shipped", "Damage during transit"].map(li => (
                        <li key={li} className="flex items-center gap-3 text-xs font-bold text-slate-600">
                           <CheckCircle2 size={16} className="text-[#5ba12d] flex-shrink-0" /> {li}
                        </li>
                      ))}
                   </ul>
                   <p className="mt-6 text-[10px] font-black text-[#336fa5] uppercase tracking-widest">Window: 7 Days from Delivery</p>
                </div>
                <div className="p-8 rounded-[2rem] bg-slate-900 text-white shadow-xl flex flex-col justify-between min-h-[160px]">
                   <p className="text-sm font-medium opacity-80 leading-relaxed">
                     Digital services are exchangeable via tier adjustments or technology switches 
                     within the project scope.
                   </p>
                   <button onClick={() => setIsModalOpen(true)} className="mt-6 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-[#5ba12d]">
            ...
            <div id="service-mod" className="scroll-mt-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-8 rounded-[2rem] bg-slate-50 border border-slate-200">
                   ...
                   <ul className="space-y-3">
                      {["Service Tier Adjustments", "Technology Switching", "Timeline adjustments", "Resource changes"].map(li => (
                        <li key={li} className="flex items-center gap-3 text-xs font-bold text-slate-600">
                           <CheckCircle2 size={16} className="text-[#5ba12d] flex-shrink-0" /> {li}
                        </li>
                      ))}
                ...
                <div className="p-8 rounded-[2rem] bg-slate-900 text-white">
                   ...
                   <p className="text-xs opacity-70 leading-relaxed">
                     Submit written requests via support@webronic.com. We assess impacts on cost and timeline before providing a formal change order.
                   </p>
                </div>
              </div>
            </div>
            ...
            <div id="international" className="scroll-mt-24">
              ...
              <div className="p-8 rounded-[2.5rem] bg-slate-50 border border-slate-100">
                ...
                <div className="flex items-center gap-3 text-[10px] font-black uppercase text-red-500">
                   <AlertCircle size={14} className="flex-shrink-0"/> Trade-restricted countries are excluded.
                </div>
              </div>
            </div>
            ...
            <div id="force-majeure" className="scroll-mt-24">
              ...
              <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden">
                 <AlertCircle size={180} className="absolute -right-10 -bottom-10 opacity-5 pointer-events-none" />
            ...
            <div className="mt-20 pt-16 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-12">
               <div>
                  ...
                  <div className="mt-8 space-y-4">
                     <div className="flex items-center gap-4 text-sm font-bold text-[#336fa5] break-all">
               ...
               <div className="bg-[#336fa5]/5 p-8 md:p-10 rounded-[2.5rem] border border-[#336fa5]/10 flex flex-col justify-between">
                  <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-6 text-center md:text-left">Include order reference in all communications.</p>
                  <button onClick={() => setIsModalOpen(true)} className="w-full flex items-center justify-center gap-3 bg-[#336fa5] text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[#5ba12d] transition-all shadow-xl active:scale-95">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 md:p-10 max-h-[90vh] overflow-y-auto">
            ...
            {!isSubmitted ? (
              <form className="space-y-4 pt-4" onSubmit={handleSubmit}>
                <h3 className="text-2xl font-black text-slate-900 tracking-tight">Support Request</h3>
                <p className="text-slate-500 text-sm font-medium mb-6">Enter details for shipping assistance.</p>
                ...
                <textarea placeholder="Query / Order Reference" rows={4} className="w-full p-4 rounded-xl bg-slate-50 border border-slate-100 text-sm outline-none focus:border-[#336fa5] resize-none transition-all" required />
                <button className="w-full bg-[#336fa5] text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] shadow-lg hover:bg-slate-900 transition-all active:scale-95">Send Query</button>
              </form>
            ) : (
