...
export default function ProductSection() {
  return (
    <section id="products" className="relative overflow-hidden bg-white py-20 lg:py-32 font-sora">
            ...
            >
              ...
              <div className="flex-1 space-y-6">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold uppercase tracking-[0.2em]" style={{ color: product.color2 }}>
                      {product.tagline}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  {product.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-2 bg-slate-50 border border-slate-100 px-3 py-1.5 rounded-lg">
                      <CheckCircle2 size={16} style={{ color: product.color1 }} />
              ...
              <div className="flex-1 relative w-full max-w-[540px]">
                <Link href={product.link} target="_blank">
                  <div 
                    className="absolute inset-0 rounded-full blur-[100px] opacity-10 transition-opacity group-hover:opacity-20"
                    
                  />
                  <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6  transition-all duration-700 group-hover:border-blue-200/50">
                    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-slate-50">
                      <img
                        ...
                        onError={(e) => {
                          (e.target as any).src = "https://via.placeholder.com/600x400/f8fafc/64748b?text=Product+UI";
                        }}
                      />
                    </div>
